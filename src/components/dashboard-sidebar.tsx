...
export default function DashboardSidebar() {
  ...
  return (
    <aside className="w-64 relative hidden md:flex shadow-md flex-col justify-between bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 text-card-foreground border-r border-primary/50">
      <div className="p-2">
