...
export const BackupFailedEmail = ({
  error,
  timestamp,
          ...
          <Container className="p-45 bg-white rounded-lg shadow">
            ...
            <Section className="mb-8">
              <div className="mb-4 p-6 bg-gray-50 rounded-lg">
                ...
                <Text className="text-red-600 whitespace-pre-wrap font-mono text-sm">
                  {error}
                </Text>
              </div>
            </Section>
            ...
            <Section className="mt-8 pt-8 border-t border-gray-200">
              <Text className="text-sm text-gray-600 text-center">
                ...
                Please investigate this issue as soon as possible to ensure data
                safety.
              </Text>
            </Section>
          </Container>
