...
export const useCreateInterviewStore = create(
  devtools<CreateInterviewState & { actions: CreateInterviewActions }>(
    (set) => ({
      ...initialState,
      actions: {
...
export const useCreateInterviewStep = () =>
  useCreateInterviewStore((state) => state.step);
export const useCreateInterviewCVText = () =>
  useCreateInterviewStore((state) => state.cvText);
...
export const useCreateInterviewDuration = () =>
  useCreateInterviewStore((state) => state.duration);
...
export const useCreateInterviewActions = () =>
  useCreateInterviewStore((state) => state.actions);
